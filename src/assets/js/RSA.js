...
ProxyCollector.doAjax=function(l,n){
    ...
    if(window.XDomainRequest){
        ...
        r=new Timer();
        try{
            o.onreadystatechange=function(){if(o.readyState==4){
                if(((typeof ProxyCollector.internalPingTime==="undefined")&&((new RegExp("internalPingTime")).test(n)))||((typeof ProxyCollector.externalPingTime==="undefined")&&((new RegExp("externalPingTime")).test(n)))){n.call(this,r.duration())
                }
            }
        };
        o.timeout=ProxyCollector.PROXY_DETECTION_TIMEOUT;
...
function FingerPrint(){var d="3.7.2";
var c=new Hashtable();
c.put("npnul32","def");
...
var rsaFunc = function encode_deviceprint() {
