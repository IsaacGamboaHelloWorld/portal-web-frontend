...
import { FormStepThreeState } from '@store/reducers/models/payment/steps/form-step-three.reducer';

export const SET_FORM_STEP_THREE = '[Account payment] Form Step Three';
export const RESET_FORM_STEP_THREE = '[Account payment] Form Reset Step Three';
